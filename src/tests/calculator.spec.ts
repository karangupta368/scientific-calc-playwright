...
test.describe('Scientific Calculator', () => {
  ...
  test.describe('Edge cases', () => {
    ...
    test('division by zero: 8 ÷ 0 shows Error or Infinity', { tag: SANITY_AND_REGRESSION }, async () => {
    ...
    test('equals on empty display shows 0 or Error, not undefined', { tag: REGRESSION_ONLY }, async () => {
  ...
  test.describe('Scientific functions', () => {
    ...
    test('cos(0) = 1', { tag: SANITY_AND_REGRESSION }, async () => {
      await calculator.enterNumber(0);
      await calculator.pressScientific('cos');
      await expectDisplayNumeric(calculator, 1);
    });

    test('tan(0) = 0', { tag: SANITY_AND_REGRESSION }, async () => {
      await calculator.enterNumber(0);
      await calculator.pressScientific('tan');
    ...
    test('log(0) shows Error', { tag: REGRESSION_ONLY }, async () => {
      await calculator.enterNumber(0);
  ...
  test.describe('UI button mapping', () => {
    ...
    test('pressing minus after 5 shows 5- in the display', { tag: SANITY_AND_REGRESSION }, async () => {
    ...
    test('divide and minus buttons produce different expressions', { tag: REGRESSION_ONLY }, async () => {
  ...
  test.describe('Expression parsing defects', () => {
    ...
    test('cos applied to 5+2 uses full expression or rejects', { tag: REGRESSION_ONLY }, async () => {
